...
- [Issues](https://github.com/transparencia-mg/): Para iniciar uma discussão sobre melhorias na documentação.
- [Pull requests](https://github.com/transparencia-mg/): Para sugerir uma alteração concreta na documentação.
...
- [Fale Conosco](https://planejamento.mg.gov.br/pagina/fale-conosco): Dúvidas
